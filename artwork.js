function about(){
	...
	function artWork11() {
		...
		document.getElementById("information2").innerHTML = "Date of Production: June 1889<br> Type of the painting colours: Oil on Canvas <br> Dimensions: 73.7cm x 92.1cm<br> Location: Museum of Modern Art, NYC<br> Artist: Vincent van Gosh<br> Price: N/A<br> Genre: Post-Impressionist" ;
	}
	...
	function artWork22() {
		...
		document.getElementById("information2").innerHTML = "Date of Production:Sept. 1869<br> Type of the painting colours: Oil on Canvas<br> Dimensions: 74.6cm x 99.7cm<br> Location: Metropolitan Museum of Art<br> Artist: Claude Monet<br> Price: N/A<br> Genre: Impressionist" ;
	}
	...
	function artWork33() {
		...
		document.getElementById("information2").innerHTML = "Date of Production: 1490s<br> Type of the painting colours: Fresco-secco<br> Dimensions: 460cm x 880cm<br> Location: Convent of Santa Maria delle Grazie, Milan<br> Artist: Leonardo da Vinci<br> Price: N/A <br> Genre: High Renaissance" ;
	}
	function artWork4() {
		show();
		document.getElementById("artArtists").style.display = "-webkit-box";
	...
	function artWork44() {
		...
		document.getElementById("information2").innerHTML = "Date of Production: 1930<br> Type of the painting colours: Oil on Beaverboard<br> Dimensions: 78cm x 65.3cm<br> Location: Art Institute of Chicago<br> Artist: Grant Wood<br> Price: N/A <br> Genre: Southern Gothic" ;
	}
	...
	function artWork55() {
		...
		document.getElementById("information2").innerHTML = "Date of Production: 1964<br> Type of the painting colours: Oil on Canvas<br> Dimensions: 116cm x 89cm<br> Location: Private Collection<br> Artist: René Magritte<br> Price: Unknown <br> Genre: Surrealist" ;
	}
